...
async function loadFacts() {
  const res = await fetch(
    "https://hxxjibcdgqoqztdkqind.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imh4eGppYmNkZ3FvcXp0ZGtxaW5kIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTQxMjMwMzgsImV4cCI6MjAyOTY5OTAzOH0.6Kthz_FJ2_J192A_nWCZWA7gLVDweLQEcbZaZr-gPZM",
      },
    }
  );
...
function createFactsList(dataArray) {
  ...
  ); //punem in variabila toate blocurile de html
  console.log(htmlArr); //afisam blocurile
  const html = htmlArr.join(""); //le unim prin spatiu, astfel apar cu virgula
  factsList.insertAdjacentHTML("afterbegin", html); //finalul - afisaj corespunzator
}
...
const x = [7, 64, 6, -23, 11].filter((el) => el > 10);
console.log(x);

/*

/*let voteInteresting = 23;
console.log("Upvotes", voteInteresting);
...
const message = totalUpvotes > votesFalse ? "True" : "Might be False";
alert(message);
